...
pub use dynamically_addressed::DynamicRegister;
pub use fake_register::FakeRegister;
pub use register_traits::{Modify, Read, Register, UnsafeRead, UnsafeWrite, Write};
pub use staticly_addressed::{StaticRegister, StaticRegisterBlock};

use core::fmt::Debug;
use core::ops::{BitAnd, BitOr, BitOrAssign, Not, Shl, Shr};

pub type RegisterCopy<T> = LocalRegisterCopy<<T as DataType>::Value, T>;
